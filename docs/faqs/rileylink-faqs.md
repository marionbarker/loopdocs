...
!!! danger "RileyLink vs radio-link"
    ...
    - Because the RileyLink has been around longer, there may be extra information about the RileyLink without corresponding information on the other radio-links
...
## What are some ideas for carrying the radio-link?
...
When you leave the house, you want to get in the habit of carrying radio-link with you, yes. A pocket, carabiner, lanyard, SPIbelt...the options are endless. What you don't want to do is put the radio-link in a blocking bag that has RFID blocking (some travel fanny packs have that). The distance that your radio-link can be away from your pump will depend heavily on the environment you are in and the type of radio-link. You may find for RileyLink that it works best if you keep it on the same side of your body as your pump.
...
## What is the most common issue for the RileyLink?
...
Try this if you are having persistent red loops associated with pump communication that are not resolved by toggling phone Bluetooth off then on again. You might need to do this, even if the firmware (next paragraph) is correct.
...
## Can I run Loop without a radio-link?
