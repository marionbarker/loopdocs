...
The Loop app uses the Health app to record blood glucose, insulin, and carbohydrate data. The blood glucose, insulin, and carbohydrate data stored in the Health app can also be accessed and uploaded by Tidepool's Mobile app. Please review the settings below to ensure you have the proper settings.
