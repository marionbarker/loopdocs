...
!!! warning "FAQs"
    - **RileyLink vs radio-link**: The RileyLink is the original design. It was the first and only radio-link for many years. Other DIY Loopers have created several other options. A new section has been added to this page: [Radio-link Options](step5.md#radio-link-options). You may see RileyLink in a lot of documentation and graphics. On this page, radio-link is generic and RileyLink is specific to that version.
    - **"Do I need a radio-link?"** Yes. Loop will not work without a radio-link.
    - **"What happens if I lose my radio-link or walk away from it?"** Good question...answered [here](../faqs/rileylink-faqs.md#what-happens-if-i-walk-away-from-my-radio-link).
    ...
    - **"How close does the radio-link need to be to me? Do I have to carry it with me?"** Good questions...answered [here](../faqs/rileylink-faqs.md#do-i-have-to-carry-the-radio-link-everywhere).
...
The radio-link is an open-source hardware device that can bridge Bluetooth Low Energy (BLE) to the radio-frequency wireless communication used by select Medtronic and Omnipod pumps. What does that mean to you? It means radio-link is the communication highway between your insulin pump, CGM, and iPhone.
...
## Extra Details about Radio-links
...
### Radio-link and RileyLink Range

The range at which all radio-links will function is **heavily** dependent on the environment that you are in. Both the EmaLink and OrangeLink have reported longer ranges, so they can be kept in a central location - but still need to be "near enough".
...
The rest of this section discusses the RileyLink range.
