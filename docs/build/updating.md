...
!!! warning "Revoke certificate"
    ...
    **WAIT - You might not need to revoke your certificate**
    ...
    1. Your version of Xcode is out-of-date
        ...
        * Check that your [Xcode version](step8.md) is up to date with your phone iOS
    1. The experts are doing tests to understand other reasons why this might happen - check back for updates
