...
For new people - you may be wondering why you care?
  ...
  * Loop has to be rebuilt at least once a year (the app expires)
...
When you turn off automatic updates, then you can choose when to update your phone. **Please be proactive - install that update as soon as the "Loop" all-clear is given. If your Mac is limiting your ability to update your phone, be aware of security concerns.** We recommend that updates be installed as soon as the All-Clear is given.  Updates are important.
